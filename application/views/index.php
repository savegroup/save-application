            ...
            <table class="table table-striped table-bordered color-table success-table">
				...
				var myChart = new Chart(ctx, {
					...
					data: {
						...
						datasets: [{
							...
							backgroundColor:nes_colors ,
							borderColor: nes_colors,
							borderWidth: 1
						}]
					},
					options: {
			  ...
			  <script>
				...
				var myChart2 = new Chart(ctx2, {
	  			...
	  			<div class="row">
	  			<?php
                    $file = fopen("datasets/historic_l.csv","r");
					$firstcol_l;
					$secondcol_l;
                    while(! feof($file)){
                        //echo "<tr>";
                ...
                ?>
				  <div class="col-md-6 ">
					<div class="x_panel">
					  <div class="x_title">
						<h2>Electricity Real Usage by Level</h2>

						<div class="clearfix"></div>
					  </div>
					  <div class="x_content">
						<canvas id="lineChart_l"></canvas>
					  </div>
				  ...
				  <div class="col-md-6 ">
					<div class="x_panel">
					  <div class="x_title">
						  <h2>Electricity Usage Prediction By Level </h2>
							<div class="clearfix"></div>
						</div>
						<div class="x_content">
							<canvas id="lineChart2_l"></canvas>
						</div>
					</div>
				   </div>
              
              <script>
				var ctx = document.getElementById("lineChart_l").getContext('2d');
				  
				var myChart_l = new Chart(ctx, {
					type: 'bar',
					data: {
						labels: [<?php
							$c=0;
							foreach($firstcol_l as $f){ 
								if($c==0){
									echo "'".$f."'";
									$c++;
								}else{
			  ...
			  <?php
                    $file = fopen("datasets/predicted_l.csv","r");
					$col1_l;
					$col2_l;
                    while(! feof($file)){
                        $b = fgetcsv($file);
                ...
                ?>
			  <script>
				var ctx2 = document.getElementById("lineChart2_l").getContext('2d');
				var myChart2_l = new Chart(ctx2, {
					type: 'bar',
					data: {
						labels: [<?php
							$c=0;
